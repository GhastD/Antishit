...
public class BlockUtil {
    ...
    public static boolean againstWall(Player player) {
        ...
        Location xPos = loc.subtract(0.5, 0, 0);
        Location yPos = loc.add(0, 0.5, 0);
        Location zPos = loc.add(0, 0, 0.5);
        Location xNeg = loc.subtract(0.5, 0, 0);
        Location yNeg = loc.subtract(0, 0.5, 0);
        Location zNeg = loc.subtract(0, 0, 0.5);
